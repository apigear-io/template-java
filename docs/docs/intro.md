...
title: "Java & Android SDK Generator - ApiGear Template"
description: "Generate Java interfaces, Android service/client IPC, and JNI bridge code from API definitions with the ApiGear code generator."
keywords: [java, android, api generator, code generator, apigear, java template, android service]
---
...
:::tip
If you only need Java interfaces and data types without Android or JNI integration, you can generate just the `api` and `stubs` features. See [Features](features/features.md) for the full list.
:::
