...
/**
 * Shared singleton {{Camel .Interface.Name}}JniServiceFactory thread for the system.  This is a thread for
 * {{Camel .Interface.Name}}JniServiceFactory connectivity.
 * Various connectivity manager objects can use this singleton as a common
 * resource for their handlers instead of creating separate threads of their own.
 *
 * @hide
 */
public class {{Camel .Interface.Name}}JniServiceFactory extends HandlerThread implements I{{Camel .Interface.Name }}ServiceFactory
{
	...
	public static {{Camel .Interface.Name}}JniServiceFactory get()
	{
	...
	public synchronized  Abstract{{Camel .Interface.Name }} getServiceInstance()
	{
		if (jniService == null)
		{
			...
			Log.d("UE", "LIFECYCLE: EngineFactory::GetInstance(with OBBFilename) - CREATED new {{Camel .Interface.Name}}JniService");
		}
	...
	{
		private static final {{Camel .Interface.Name}}JniServiceFactory INSTANCE = createInstance();
	}

	private {{Camel .Interface.Name}}JniServiceFactory()
	{
		super("EngineFactory");
	}
