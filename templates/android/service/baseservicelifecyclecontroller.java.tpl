...
// it requires the real backend service. The {{Camel .Interface.Name }}ServiceAdapter is just an adapter,
...
public abstract class {{Camel .Interface.Name }}BaseServiceLifecycleController
{
    ...
    {
        private static final String TAG = "{{Camel .Interface.Name }} LifecycleServiceConnection";
