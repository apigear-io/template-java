...
// it requires the real backend service. The NamEsServiceAdapter is just an adapter,
...
public abstract class NamEsBaseServiceLifecycleController
{
    ...
    {
        private static final String TAG = "NamEs LifecycleServiceConnection";
