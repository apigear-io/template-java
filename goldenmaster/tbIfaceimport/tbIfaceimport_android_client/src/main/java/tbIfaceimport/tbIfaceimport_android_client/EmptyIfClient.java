...
{
	private static final String TAG = "EmptyIfClient";
	...
	public EmptyIfClient(Context applicationContext, String connectionId)
	{
	...
	/**
     * Binds to a running service of type EmptyIfServiceAdapter.
     *
    ...
    public boolean bindToService(String packageName)
    {
        ...
        intent.setClassName(packageName, "tbIfaceimport.tbIfaceimport_android_service.EmptyIfServiceAdapter");
    ...
    public void unbindFromService()
    {
        if (mIsBoundToService)
        {
            ...
            Message msg = Message.obtain(null, EmptyIfMessageType.UNREGISTER_CLIENT.ordinal());
    ...
    private void requestRegisterClient()
    {
        ...
        {
            Message msg = Message.obtain(null, EmptyIfMessageType.REGISTER_CLIENT.ordinal());
