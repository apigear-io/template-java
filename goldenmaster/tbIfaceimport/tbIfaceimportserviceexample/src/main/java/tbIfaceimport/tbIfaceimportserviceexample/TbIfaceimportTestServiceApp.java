package tbIfaceimport.tbIfaceimportserviceexample;
...
public class TbIfaceimportTestServiceApp extends Activity implements IEmptyIfEventListener
{

    private static final String TAG = "TbIfaceimportTestServiceApp";
    static Intent stub_service = null;


    private IEmptyIf mBackend = null;
