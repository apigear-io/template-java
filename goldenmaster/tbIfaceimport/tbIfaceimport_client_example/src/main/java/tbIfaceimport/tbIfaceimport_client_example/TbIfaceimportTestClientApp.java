package tbIfaceimport.tbIfaceimport_client_example;
...
public class TbIfaceimportTestClientApp extends Activity implements IEmptyIfEventListener
{

    private static final String TAG = "TbIfaceimportTestClientApp";

    private EmptyIfClient mClient = null;

    //TODO ALIGN TO YOUR APP 
    private static String mModuleNameUnreal = "com.example.TestAndroid";
    private static String mModuleNameStub = "tbIfaceimport.tbIfaceimportserviceexample.TbIfaceimportTestServiceApp";
    ...
    private void initServiceConnection( String servicePackage)
    {
        ...
        if (mClient == null)
        {
            mClient = new EmptyIfClient(this.getApplicationContext(), "");
