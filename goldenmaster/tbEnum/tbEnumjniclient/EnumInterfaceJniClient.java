...
public class EnumInterfaceJniClient extends AbstractEnumInterface implements IEnumInterfaceEventListener
{
    ...
    {
        Log.w(TAG, "NOTIFICATION from messenger client Signal sig0 "+ " " + param0);
        nativeOnSig0(param0);
    }
    @Override
    ...
    {
        Log.w(TAG, "NOTIFICATION from messenger client Signal sig2 "+ " " + param2);
        nativeOnSig2(param2);
    }
    @Override
    public void onSig3(Enum3 param3)
    {
        Log.w(TAG, "NOTIFICATION from messenger client Signal sig3 "+ " " + param3);
        nativeOnSig3(param3);
    }
