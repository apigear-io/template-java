...
// it requires the real backend service. The EnumInterfaceServiceAdapter is just an adapter,
...
public abstract class EnumInterfaceBaseServiceLifecycleController
{
    ...
    {
        private static final String TAG = "EnumInterface LifecycleServiceConnection";
