...
public class VoidInterfaceClient extends AbstractVoidInterface implements ServiceConnection
{
	private static final String TAG = "VoidInterfaceClient";
	...
	public VoidInterfaceClient(Context applicationContext, String connectionId)
	{
	...
	/**
     * Binds to a running service of type VoidInterfaceServiceAdapter.
     *
    ...
    public boolean bindToService(String packageName)
    {
        ...
        intent.setClassName(packageName, "tbSimple.tbSimple_android_service.VoidInterfaceServiceAdapter");
    ...
    public void unbindFromService()
    {
        if (mIsBoundToService)
        {
            ...
            Message msg = Message.obtain(null, VoidInterfaceMessageType.UNREGISTER_CLIENT.ordinal());
    ...
    private void requestRegisterClient()
    {
        ...
        {
            Message msg = Message.obtain(null, VoidInterfaceMessageType.REGISTER_CLIENT.ordinal());
	    ...
	    public void handleMessage(Message msg)
	    {
		    ...
		    switch (VoidInterfaceMessageType.fromInteger(msg.what))
		    {
			    ...
			    case RPC_FuncVoidResp: {
                    ...
                    {
                        Log.v(TAG, "received VoidInterfaceMessageType.RPC_FuncVoidResp , could not find pending call for " + msg.obj);
                    }
				    break;
    ...
    public  CompletableFuture<Void> funcVoidAsync() {
		...
		msg.what = VoidInterfaceMessageType.RPC_FuncVoidReq.getValue();
