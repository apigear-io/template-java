...
public class EmptyInterfaceClient extends AbstractEmptyInterface implements ServiceConnection
{
	private static final String TAG = "EmptyInterfaceClient";
	...
	public EmptyInterfaceClient(Context applicationContext, String connectionId)
	{
	...
	/**
     * Binds to a running service of type EmptyInterfaceServiceAdapter.
     *
    ...
    private void requestRegisterClient()
    {
        ...
        {
            Message msg = Message.obtain(null, EmptyInterfaceMessageType.REGISTER_CLIENT.ordinal());
