...
// it requires the real backend service. The SimpleArrayInterfaceServiceAdapter is just an adapter,
...
public abstract class SimpleArrayInterfaceBaseServiceLifecycleController
{
    ...
    {
        private static final String TAG = "SimpleArrayInterface LifecycleServiceConnection";
