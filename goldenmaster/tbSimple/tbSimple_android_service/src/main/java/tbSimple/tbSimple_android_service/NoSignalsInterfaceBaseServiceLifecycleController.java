...
// it requires the real backend service. The NoSignalsInterfaceServiceAdapter is just an adapter,
...
public abstract class NoSignalsInterfaceBaseServiceLifecycleController
{
    ...
    {
        private static final String TAG = "NoSignalsInterface LifecycleServiceConnection";
