...
// it requires the real backend service. The VoidInterfaceServiceAdapter is just an adapter,
...
public abstract class VoidInterfaceBaseServiceLifecycleController
{
    ...
    {
        private static final String TAG = "VoidInterface LifecycleServiceConnection";
