...
// it requires the real backend service. The NoPropertiesInterfaceServiceAdapter is just an adapter,
...
public abstract class NoPropertiesInterfaceBaseServiceLifecycleController
{
    ...
    {
        private static final String TAG = "NoPropertiesInterface LifecycleServiceConnection";
