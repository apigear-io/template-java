...
// it requires the real backend service. The EmptyInterfaceServiceAdapter is just an adapter,
...
public abstract class EmptyInterfaceBaseServiceLifecycleController
{
    ...
    {
        private static final String TAG = "EmptyInterface LifecycleServiceConnection";
