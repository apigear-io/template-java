...
// it requires the real backend service. The NestedStruct2InterfaceServiceAdapter is just an adapter,
...
public abstract class NestedStruct2InterfaceBaseServiceLifecycleController
{
    ...
    {
        private static final String TAG = "NestedStruct2Interface LifecycleServiceConnection";
