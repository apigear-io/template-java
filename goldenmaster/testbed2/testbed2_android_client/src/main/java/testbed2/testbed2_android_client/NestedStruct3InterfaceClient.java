...
{
	private static final String TAG = "NestedStruct3InterfaceClient";
	...
	public NestedStruct3InterfaceClient(Context applicationContext, String connectionId)
	{
	...
	/**
     * Binds to a running service of type NestedStruct3InterfaceServiceAdapter.
     *
    ...
    private void requestRegisterClient()
    {
        ...
        {
            Message msg = Message.obtain(null, NestedStruct3InterfaceMessageType.REGISTER_CLIENT.ordinal());
    ...
    public  CompletableFuture<NestedStruct1> func1Async(NestedStruct1 param1) {
		...
		Message msg = new Message();
		msg.what = NestedStruct3InterfaceMessageType.RPC_Func1Req.getValue();
		Bundle data = new Bundle();
    ...
    public  CompletableFuture<NestedStruct1> func2Async(NestedStruct1 param1, NestedStruct2 param2) {
		...
		Message msg = new Message();
		msg.what = NestedStruct3InterfaceMessageType.RPC_Func2Req.getValue();
		Bundle data = new Bundle();
        int msgId =  callIdsGetter.getAndIncrement();
        data.putInt("callId",msgId);
    ...
    public  CompletableFuture<NestedStruct1> func3Async(NestedStruct1 param1, NestedStruct2 param2, NestedStruct3 param3) {
		...
		Message msg = new Message();
		msg.what = NestedStruct3InterfaceMessageType.RPC_Func3Req.getValue();
		Bundle data = new Bundle();
        int msgId =  callIdsGetter.getAndIncrement();
        data.putInt("callId",msgId);
