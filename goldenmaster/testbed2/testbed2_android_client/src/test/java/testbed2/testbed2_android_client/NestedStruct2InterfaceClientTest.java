...
interface INestedStruct2InterfaceClientMessageGetter
{
...
public class NestedStruct2InterfaceClientTest
{

    @Mock
    private Context mMockContext;
   
    private NestedStruct2InterfaceClient testedClient;
    private INestedStruct2InterfaceEventListener listenerMock = mock(INestedStruct2InterfaceEventListener.class);
    ...
    private INestedStruct2InterfaceClientMessageGetter serviceMessagesStorage = mock(INestedStruct2InterfaceClientMessageGetter.class);
    ...
    public void tearDown() {
        ...
        assertEquals(NestedStruct2InterfaceMessageType.UNREGISTER_CLIENT.getValue(), register_msg.what);
    ...
    Handler createServiceHandlerMock(INestedStruct2InterfaceClientMessageGetter messageGetterMock)
    {
    ...
    public void setUp() throws RemoteException
    {
        ...
        testedClient = new NestedStruct2InterfaceClient(mMockContext, mTestConnectionID1);
        testedClient.addEventListener(listenerMock);
        ComponentName componentName = new ComponentName("testbed2.testbed2_android_service", "testbed2.testbed2_android_service.NestedStruct2InterfaceServiceAdapter");
        testedClient.onServiceConnected(componentName, serviceBinder);

        Robolectric.flushForegroundThreadScheduler();
        inOrderServiceMessenger.verify(serviceMessagesStorage, times(1)).getMessage(messageCaptor.capture());
        Message register_msg = messageCaptor.getValue();
        assertEquals(NestedStruct2InterfaceMessageType.REGISTER_CLIENT.getValue(), register_msg.what);
    ...
    //PREPARE message
        ...
        Message msg = Message.obtain(null, NestedStruct2InterfaceMessageType.INIT.getValue());
    ...
    public void onReceiveprop1PropertyChangeTest() throws RemoteException {
        ...
        Message msg = Message.obtain(null, NestedStruct2InterfaceMessageType.SET_Prop1.getValue());
        Bundle data = new Bundle();
        NestedStruct1 testprop1 = Testbed2TestHelper.makeTestNestedStruct1();
		data.putParcelable("prop1", new NestedStruct1Parcelable(testprop1));
     ...
     public void setPropertyRequestprop1()
    {
        ...
        assertEquals(NestedStruct2InterfaceMessageType.PROP_Prop1.getValue(), response.what);
    ...
    public void onReceiveprop2PropertyChangeTest() throws RemoteException {
        // Create and send message
        Message msg = Message.obtain(null, NestedStruct2InterfaceMessageType.SET_Prop2.getValue());
        Bundle data = new Bundle();
        NestedStruct2 testprop2 = Testbed2TestHelper.makeTestNestedStruct2();
		data.putParcelable("prop2", new NestedStruct2Parcelable(testprop2));
     ...
     public void setPropertyRequestprop2()
    {
        ...
        assertEquals(NestedStruct2InterfaceMessageType.PROP_Prop2.getValue(), response.what);
        Bundle data = response.getData();
    ...
    public void whenNotifiedsig1() throws RemoteException
    {
        ...
        Message msg = Message.obtain(null, NestedStruct2InterfaceMessageType.SIG_Sig1.getValue());
        Bundle data = new Bundle();
    ...
    public void whenNotifiedsig2() throws RemoteException
    {
        ...
        Message msg = Message.obtain(null, NestedStruct2InterfaceMessageType.SIG_Sig2.getValue());
        Bundle data = new Bundle();
        NestedStruct1 testparam1 = Testbed2TestHelper.makeTestNestedStruct1();
		data.putParcelable("param1", new NestedStruct1Parcelable(testparam1));
    ...
    public void onfunc1Request() throws RemoteException {
        ...
        assertEquals(NestedStruct2InterfaceMessageType.RPC_Func1Req.getValue(), method_request.what);
        ...
        Message msg = Message.obtain(null, NestedStruct2InterfaceMessageType.RPC_Func1Resp.getValue());
    ...
    public void onfunc2Request() throws RemoteException {
        ...
        Message method_request = messageCaptor.getValue();
        assertEquals(NestedStruct2InterfaceMessageType.RPC_Func2Req.getValue(), method_request.what);
        Bundle data = method_request.getData();
        ...
        Message msg = Message.obtain(null, NestedStruct2InterfaceMessageType.RPC_Func2Resp.getValue());
