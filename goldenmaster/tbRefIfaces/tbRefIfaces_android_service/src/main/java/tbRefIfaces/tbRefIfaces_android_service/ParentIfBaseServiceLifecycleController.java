...
// it requires the real backend service. The ParentIfServiceAdapter is just an adapter,
...
public abstract class ParentIfBaseServiceLifecycleController
{
    ...
    {
        private static final String TAG = "ParentIf LifecycleServiceConnection";
