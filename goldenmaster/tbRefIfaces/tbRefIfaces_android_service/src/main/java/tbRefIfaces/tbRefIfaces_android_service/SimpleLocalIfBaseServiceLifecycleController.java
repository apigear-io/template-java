...
// it requires the real backend service. The SimpleLocalIfServiceAdapter is just an adapter,
...
public abstract class SimpleLocalIfBaseServiceLifecycleController
{
    ...
    {
        private static final String TAG = "SimpleLocalIf LifecycleServiceConnection";
