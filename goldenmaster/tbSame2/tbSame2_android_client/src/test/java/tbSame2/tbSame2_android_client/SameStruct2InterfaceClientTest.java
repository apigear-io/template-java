...
interface ISameStruct2InterfaceClientMessageGetter
{
...
public class SameStruct2InterfaceClientTest
{

    @Mock
    private Context mMockContext;
   
    private SameStruct2InterfaceClient testedClient;
    private ISameStruct2InterfaceEventListener listenerMock = mock(ISameStruct2InterfaceEventListener.class);
    ...
    public void tearDown() {
        ...
        assertEquals(SameStruct2InterfaceMessageType.UNREGISTER_CLIENT.getValue(), register_msg.what);
    ...
    Handler createServiceHandlerMock(ISameStruct2InterfaceClientMessageGetter messageGetterMock)
    {
    ...
    public void setUp() throws RemoteException
    {
        ...
        testedClient = new SameStruct2InterfaceClient(mMockContext, mTestConnectionID1);
        testedClient.addEventListener(listenerMock);
        ComponentName componentName = new ComponentName("tbSame2.tbSame2_android_service", "tbSame2.tbSame2_android_service.SameStruct2InterfaceServiceAdapter");
        testedClient.onServiceConnected(componentName, serviceBinder);

        Robolectric.flushForegroundThreadScheduler();
        inOrderServiceMessenger.verify(serviceMessagesStorage, times(1)).getMessage(messageCaptor.capture());
        Message register_msg = messageCaptor.getValue();
        assertEquals(SameStruct2InterfaceMessageType.REGISTER_CLIENT.getValue(), register_msg.what);
    ...
    //PREPARE message
        ...
        Message msg = Message.obtain(null, SameStruct2InterfaceMessageType.INIT.getValue());
        Bundle data = new Bundle();
        Struct2 testprop1 = TbSame2TestHelper.makeTestStruct2();
		data.putParcelable("prop1", new Struct2Parcelable(testprop1));
        Struct2 testprop2 = TbSame2TestHelper.makeTestStruct2();
		data.putParcelable("prop2", new Struct2Parcelable(testprop2));

    //setup mock expectations
        msg.setData(data);
        mClientMessenger.send(msg);
        Robolectric.flushForegroundThreadScheduler();
        inOrderEventListener.verify(listenerMock,times(1)).onProp1Changed(any(Struct2.class));
        inOrderEventListener.verify(listenerMock,times(1)).onProp2Changed(any(Struct2.class));
    }
    @Test
    public void onReceiveprop1PropertyChangeTest() throws RemoteException {
        // Create and send message
        Message msg = Message.obtain(null, SameStruct2InterfaceMessageType.SET_Prop1.getValue());
        Bundle data = new Bundle();
        Struct2 testprop1 = TbSame2TestHelper.makeTestStruct2();
		data.putParcelable("prop1", new Struct2Parcelable(testprop1));
     ...
     public void setPropertyRequestprop1()
    {
        ...
        assertEquals(SameStruct2InterfaceMessageType.PROP_Prop1.getValue(), response.what);
    ...
    public void onReceiveprop2PropertyChangeTest() throws RemoteException {
        // Create and send message
        Message msg = Message.obtain(null, SameStruct2InterfaceMessageType.SET_Prop2.getValue());
        Bundle data = new Bundle();
        Struct2 testprop2 = TbSame2TestHelper.makeTestStruct2();
		data.putParcelable("prop2", new Struct2Parcelable(testprop2));
     ...
     public void setPropertyRequestprop2()
    {
        ...
        assertEquals(SameStruct2InterfaceMessageType.PROP_Prop2.getValue(), response.what);
        Bundle data = response.getData();
		data.setClassLoader(Struct2Parcelable.class.getClassLoader());
    ...
    public void whenNotifiedsig1() throws RemoteException
    {
        ...
        Message msg = Message.obtain(null, SameStruct2InterfaceMessageType.SIG_Sig1.getValue());
        Bundle data = new Bundle();
        Struct1 testparam1 = TbSame2TestHelper.makeTestStruct1();
        ...
        inOrderEventListener.verify(listenerMock,times(1)).onSig1( any(Struct1.class));
    ...
    public void whenNotifiedsig2() throws RemoteException
    {
        ...
        Message msg = Message.obtain(null, SameStruct2InterfaceMessageType.SIG_Sig2.getValue());
        Bundle data = new Bundle();
        Struct1 testparam1 = TbSame2TestHelper.makeTestStruct1();
		data.putParcelable("param1", new Struct1Parcelable(testparam1));
        Struct2 testparam2 = TbSame2TestHelper.makeTestStruct2();
		data.putParcelable("param2", new Struct2Parcelable(testparam2));

        msg.setData(data);
        mClientMessenger.send(msg);
        Robolectric.flushForegroundThreadScheduler();
        
        inOrderEventListener.verify(listenerMock,times(1)).onSig2( any(Struct1.class),  any(Struct2.class));
    ...
    public void onfunc1Request() throws RemoteException {
        ...
        // Execute method
        Struct1 testparam1 = TbSame2TestHelper.makeTestStruct1();
        Struct1 expectedResult = TbSame2TestHelper.makeTestStruct1();

        AtomicBoolean receivedResp = new AtomicBoolean(false);
        CompletableFuture<Struct1> resFuture = testedClient.func1Async(testparam1);
        ...
        assertEquals(SameStruct2InterfaceMessageType.RPC_Func1Req.getValue(), method_request.what);
        ...
        Message msg = Message.obtain(null, SameStruct2InterfaceMessageType.RPC_Func1Resp.getValue());

        Bundle result_data = new Bundle();
		result_data.putInt("callId", returnedCallId);
		result_data.putParcelable("result", new Struct1Parcelable(expectedResult));
    ...
    public void onfunc2Request() throws RemoteException {
        ...
        AtomicBoolean receivedResp = new AtomicBoolean(false);
        CompletableFuture<Struct1> resFuture = testedClient.func2Async(testparam1, testparam2);
        ...
        assertEquals(receivedparam1, testparam1);
			...
			Struct2 receivedparam2 = data.getParcelable("param2", Struct2Parcelable.class).getStruct2();
        assertEquals(receivedparam2, testparam2);
        int returnedCallId = data.getInt("callId", -1);

        //Prepare response

        Message msg = Message.obtain(null, SameStruct2InterfaceMessageType.RPC_Func2Resp.getValue());
