...
public class TbSame2TestHelper
{
    ...
    static public ISameStruct1Interface makeTestSameStruct1Interface(ISameStruct1Interface testObjToFill) 
    {
        ...
        Struct1 localprop1 = TbSame2TestHelper.makeTestStruct1();
    ...
    {
        if (testObjToFill == null){return testObjToFill;}
        Struct2 localprop1 = TbSame2TestHelper.makeTestStruct2();
        testObjToFill.setProp1(localprop1);
        Struct2 localprop2 = TbSame2TestHelper.makeTestStruct2();
