...
// it requires the real backend service. The SameEnum2InterfaceServiceAdapter is just an adapter,
...
public abstract class SameEnum2InterfaceBaseServiceLifecycleController
{
    ...
    {
        private static final String TAG = "SameEnum2Interface LifecycleServiceConnection";
