...
// it requires the real backend service. The SameStruct1InterfaceServiceAdapter is just an adapter,
...
public abstract class SameStruct1InterfaceBaseServiceLifecycleController
{
    ...
    {
        private static final String TAG = "SameStruct1Interface LifecycleServiceConnection";
