...
{
	private static final String TAG = "SameEnum2InterfaceClient";
	...
	public SameEnum2InterfaceClient(Context applicationContext, String connectionId)
	{
	...
	/**
     * Binds to a running service of type SameEnum2InterfaceServiceAdapter.
     *
    ...
    public boolean bindToService(String packageName)
    {
        ...
        intent.setClassName(packageName, "tbSame1.tbSame1_android_service.SameEnum2InterfaceServiceAdapter");
    ...
    public void unbindFromService()
    {
        if (mIsBoundToService)
        {
            ...
            Message msg = Message.obtain(null, SameEnum2InterfaceMessageType.UNREGISTER_CLIENT.ordinal());
    ...
    private void requestRegisterClient()
    {
        ...
        {
            Message msg = Message.obtain(null, SameEnum2InterfaceMessageType.REGISTER_CLIENT.ordinal());
    ...
    class ClientHandler extends Handler {
        ...
        data.setClassLoader(Enum1Parcelable.class.getClassLoader());
			    ...
			    case RPC_Func1Resp: {
                    ...
                    {
                        Log.v(TAG, "received SameEnum2InterfaceMessageType.RPC_Func1Resp , could not find pending call for " + msg.obj);
                    }
				    break;
			    ...
			    case RPC_Func2Resp: {
                    ...
                    {
                        Log.v(TAG, "received SameEnum2InterfaceMessageType.RPC_Func2Resp , could not find pending call for " + msg.obj);
                    }
				    break;
    ...
    public void setProp1(Enum1 prop1)
    {
        ...
        if (m_prop1 != prop1)
        {
			...
			msg.what = SameEnum2InterfaceMessageType.PROP_Prop1.getValue();
    ...
    public void setProp2(Enum2 prop2)
    {
        ...
        {
			Message msg = new Message();
			msg.what = SameEnum2InterfaceMessageType.PROP_Prop2.getValue();
			Bundle data = new Bundle();
    ...
    public  CompletableFuture<Enum1> func1Async(Enum1 param1) {
		...
		Message msg = new Message();
		msg.what = SameEnum2InterfaceMessageType.RPC_Func1Req.getValue();
		Bundle data = new Bundle();
    ...
    public  CompletableFuture<Enum1> func2Async(Enum1 param1, Enum2 param2) {
		...
		Message msg = new Message();
		msg.what = SameEnum2InterfaceMessageType.RPC_Func2Req.getValue();
		Bundle data = new Bundle();
        int msgId =  callIdsGetter.getAndIncrement();
        data.putInt("callId",msgId);
