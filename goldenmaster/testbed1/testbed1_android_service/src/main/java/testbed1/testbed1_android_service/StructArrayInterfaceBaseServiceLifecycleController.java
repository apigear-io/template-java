...
// it requires the real backend service. The StructArrayInterfaceServiceAdapter is just an adapter,
...
public abstract class StructArrayInterfaceBaseServiceLifecycleController
{
    ...
    {
        private static final String TAG = "StructArrayInterface LifecycleServiceConnection";
