...
// it requires the real backend service. The StructArray2InterfaceServiceAdapter is just an adapter,
...
public abstract class StructArray2InterfaceBaseServiceLifecycleController
{
    ...
    {
        private static final String TAG = "StructArray2Interface LifecycleServiceConnection";
