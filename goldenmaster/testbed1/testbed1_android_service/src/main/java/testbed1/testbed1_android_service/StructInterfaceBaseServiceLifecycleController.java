...
// it requires the real backend service. The StructInterfaceServiceAdapter is just an adapter,
...
public abstract class StructInterfaceBaseServiceLifecycleController
{
    ...
    {
        private static final String TAG = "StructInterface LifecycleServiceConnection";
