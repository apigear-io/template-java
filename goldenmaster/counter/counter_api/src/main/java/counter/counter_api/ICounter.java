...
import java.util.concurrent.CompletableFuture;
  ...
  public interface ICounter {
    ...
    void setVectorArray(List<customTypes.customTypes_api.Vector3D> vectorArray);
    List<customTypes.customTypes_api.Vector3D> getVectorArray();
    void fireVectorArrayChanged(List<customTypes.customTypes_api.Vector3D> newValue);
  
    void setExternVectorArray(List<org.apache.commons.math3.geometry.euclidean.threed.Vector3D> extern_vectorArray);
    List<org.apache.commons.math3.geometry.euclidean.threed.Vector3D> getExternVectorArray();
    void fireExternVectorArrayChanged(List<org.apache.commons.math3.geometry.euclidean.threed.Vector3D> newValue);
    ...
    List<org.apache.commons.math3.geometry.euclidean.threed.Vector3D> incrementArray(List<org.apache.commons.math3.geometry.euclidean.threed.Vector3D> vec);
    CompletableFuture<List<org.apache.commons.math3.geometry.euclidean.threed.Vector3D>> incrementArrayAsync(List<org.apache.commons.math3.geometry.euclidean.threed.Vector3D> vec);
    ...
    List<customTypes.customTypes_api.Vector3D> decrementArray(List<customTypes.customTypes_api.Vector3D> vec);
    CompletableFuture<List<customTypes.customTypes_api.Vector3D>> decrementArrayAsync(List<customTypes.customTypes_api.Vector3D> vec);
