...
// it requires the real backend service. The CounterServiceAdapter is just an adapter,
...
public abstract class CounterBaseServiceLifecycleController
{
    ...
    {
        private static final String TAG = "Counter LifecycleServiceConnection";
